...
@Service
public class ObterDashboardSemanal {
    ...
    public ObterDashboardSemanal(ReceitaRepositorio receitaRepositorio,
    ...
    public DashboardSemanalResponse executar(LocalDate dataReferencia) {
        var usuario = UsuarioAutenticadoService.obterUsuarioAutenticado();

        LocalDate inicio = dataReferencia.with(java.time.DayOfWeek.MONDAY);
        ...
        return new DashboardSemanalResponse(
                inicio,
                fim,
                faturamentoTotal,
                despesasTotais,
